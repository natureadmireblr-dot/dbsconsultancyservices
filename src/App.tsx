      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="w-10 h-10 bg-emerald-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">D</div>
            <span className={`font-display font-bold text-xl tracking-tight ${scrolled ? 'text-slate-900' : 'text-slate-900'}`}>DBS Consultancy</span>
          </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-slate-900">devbalaji@natureadmire.in</p>
                  </div>
                </div>
                <div className="flex items-center gap-6">
              ...
              <form 
                ...
                onSubmit={async (e) => {
                  ...
                  try {
                    ...
                    if (response.ok) {
                      alert('Thank you! Your inquiry has been sent to natureadmire@gmail.com. We will get back to you soon.');
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 border-b border-slate-800 pb-12 mb-12">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-emerald-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">D</div>
              <span className="font-display font-bold text-2xl tracking-tight">DBS Consultancy</span>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-slate-500 text-sm">
            <p>© 2026 DBS Consultancy Services. All rights reserved.</p>
